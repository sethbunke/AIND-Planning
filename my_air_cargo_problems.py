...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        def load_actions():
            ...
            """
            loads = []
            # CHANGED TODO create all load ground actions from the domain Load action
        ...
        def unload_actions():
            ...
            """
            unloads = []
            # CHANGED TODO create all Unload ground actions from the domain Unload action
